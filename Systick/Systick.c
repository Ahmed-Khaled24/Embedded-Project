...
void systick_vid1msDelay(){
	NVIC_ST_RELOAD_R = 16000 - 1;  //delay of 1ms is actually 8000 cycles not 80000 (found by experimenting  that the bus clock frequency of our kit is 8MHz not 80MHz)
	NVIC_ST_CURRENT_R = 0;
