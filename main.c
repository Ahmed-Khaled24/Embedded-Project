...
int main()
{
    ...
    InterruptF_init(4); //initialize the interrupt
    InterruptE_init(0);
    GPIOF_setHandler(SW1_Interrupt); //set the interrupt handler to Program_Interrupt function
    GPIOE_setHandler(SW3_Interrupt);
